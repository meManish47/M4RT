...
export const ImageSliderComponent = async () => {
  ...
  const x = data.getAllProducts;
  const images = x.map((product) => product.imageUrl);
  ...
  return (
    <>
      ...
      <div className="w-full h-max  relative overflow-hidden flex items-center justify-center">
        {/* Background gradient */}
